...
import SongsList from '@/application/SongList/index-rtk'
...
function Singer(props: any) {
  ...
  const {
    singer: { artist, songsOfArtist: songs, loading },
    player: {
      playList: { length: songsCount },
    },
  } = useAppSelector((state: any) => state)

  const getSingerDataDispatch = (id: string) => {
    dispatch(singerSlice.actions.CHANGE_ENTER_LOADING(true))
  ...
  useEffect(() => {
    getSingerDataDispatch(id as string)
