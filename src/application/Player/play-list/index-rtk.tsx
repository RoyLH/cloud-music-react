...
function PlayList(props: any) {
  ...
  const deleteSongDispatch = (data: any) => {
    dispatch(playerSlice.actions.DELETE_SONG(data))
  }
  const clearDispatch = () => {
    dispatch(playerSlice.actions.SET_PLAYLIST([]))
    dispatch(playerSlice.actions.SET_SEQUENCE_PLAYLIST([]))
    dispatch(playerSlice.actions.SET_CURRENT_INDEX(-1))
    dispatch(playerSlice.actions.SET_SHOW_PLAYLIST(false))
    dispatch(playerSlice.actions.SET_CURRENT_SONG({}))
    dispatch(playerSlice.actions.SET_PLAYING_STATE(false))
  }
